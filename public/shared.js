...
(function (exp) {
  ...
  const C = {
    ...
    MAX_PLAYERS: 10,
    MIN_PLAYERS: 3,
    /* تخريب قطع الكهرب. البوتات ما تستخدمه، فما يأثّر على معايرة الـ ٤٠ جولة */
    SAB_MS: 25000,        // مدة الظلمة
    SAB_CD: 40000,        // كولداون مستقل عن كولداون الطيحة
    ...
    RECONNECT_MS: 30000,  // مهلة رجوع اللاعب المنقطع بنفس دوره ومهامه
  };
